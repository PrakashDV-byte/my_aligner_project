  ...
  `define CFS_ALGN_ENV_SV
   ...
   class cfs_algn_env#(int unsigned ALGN_DATA_WIDTH = 32) extends uvm_env implements uvm_ext_reset_handler;
    ...
    virtual function void connect_phase(uvm_phase phase);
      ...
      predictor.map     = model.reg_block.default_map;   //removed null and added the defualt map
      predictor.adapter = adapter;

      //Connect the APB monitor with the predictor  //uncommented this 
      ...
      virtual_sequencer.md_rx_sequencer = cfs_md_sequencer_base_master'(md_rx_agent.sequencer);   //interchanged rx and tx agents 
